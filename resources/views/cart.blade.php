...
@section('content')
    ...
    <div class="container">
        ...
        <div class="cart-list">
            ...
            <div class="cart-item">
                <img src="{{ $cartItem->img_filepath }}"  alt="product image">
                    ...
                    <h3 id="infoPrice_{{ $cartItem->id }}">€ <b>{{ $cartItem->pivot->amount * $cartItem->price }}</b></h3>
                    <div class="cart-arrows">
                        <button type="button" data-item-price="{{ $cartItem->price }}" data-item-id="{{ $cartItem->id }}">+</button>
        ...
        <h1 name="total_price"  id="totalPrice">Total price: € {{ number_format($totalPrice, 2) }}</h1>
